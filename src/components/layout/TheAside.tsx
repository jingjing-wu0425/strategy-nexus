...
import { InlineChat } from '@/components/ai/AIResponsePanel';
...
export function TheAside() {
  ...
  const renderAIContent = () => {
    ...
    if (responses.length > 0) {
      return <AIResponsePanel responses={responses} missionId={activeMissionId} />;
    }
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="border-t border-glass-border pt-4">
          ...
          <InlineChat missionId={activeMissionId} inputRef={{ current: null }} />
        </div>
      </div>
    );
  };
